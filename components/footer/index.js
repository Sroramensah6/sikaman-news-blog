    ...
    return (
        <footer className="p-4 bg-[#290916] border-y sm:p-6 sm:pb-4 mt-10 md:mt-10">
            <div className="md:flex md:justify-between">
                ...
                <div>
                <h2 className="mb-7 font-semibold text-[1rem] md:text-[1.4rem] lg:text-2xl uppercase text-[#F2F3F2] font-mediumSerif ">
                    Link a Ehia
                        ...
                        <ul className="text-[#F2F3F2] space-y-4 font-mediumSerif">
                            {main_link.slice(0, 3).map((link, index) => (
                                <li key={index}>
                                    <Link
                                        href={link.route}
                                        className={`${router.pathname === link.route ? 'bg-[#F2F3F2] text-[#290916]' : 'text-[#F2F3F2] hover:bg-[#F2F3F2] hover:text-[#290916]'} px-3 py-2 rounded-md text-sm font-medium font-mediumSerif`}
                                    >
                                        {link.title}
                                    </Link>
                                </li>
